...
print color('bold red'),"\t\t        [";
print color('bold white'),"Coded by PantherTeamSec";
print color('bold red'),"]\n";
print color('reset');
};
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold white'),"PTS @DIMASZ: $wpass ";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold white'),"PTS @DIMASZ: $joompass ";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold white'),"PTS @DIMASZ: $drupass ";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold white'),"PTS @DIMASZ: $ocpass ";
...
print color('bold green'),"+";
print color('bold red'),"] ";
print color('bold white'),"PTS @DIMASZ: $magpass ";
